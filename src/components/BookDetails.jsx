...
const BookDetails = () => {
    ...
    const { image, error, title, subtitle, authors, publisher, isbn10, isbn13, pages, year, rating, desc, price, url, pdf } = book
    return (
        <div className='my-container h-[calc(100vh-68px)]'>
            {/* Container Box */}
